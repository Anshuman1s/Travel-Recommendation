...
<head>
    ...
    <title>Travel Recommendations - Heaven Travel</title>
    ...
    <style>
        ...
        .budget-slider::-webkit-slider-thumb {
            ...
            height: 20px;
            border-radius: 50%;
            background: linear-gradient(135deg, #2b7699 0%, #0d3040 100%);
            cursor: pointer;
...
<body>
    ...
    <nav class="nav-container fixed w-full z-50 px-6 py-4">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            <a href="/" class="logo-container">
                <span class="text-2xl gradient-text">HeavenTravel</span>
            </a>
    ...
    <div class="page-header">
        ...
        <div class="page-header-content">
            ...
            <p class="page-description">Discover tailored travel recommendations based on your preferences, budget, and travel style. Let us assist in planning your next unforgettable journey.</p>
        </div>
        ...
        <div class="max-w-3xl mx-auto form-container">
            <div class="form-card floating-element">
                <div class="form-card-header">
                    ...
                    <p class="form-subtitle">Enter your details to receive customized travel suggestions tailored to your preferences.</p>
                </div>
                        ...
                        <div class="budget-container">
                            <div class="space-y-2">
                                <div class="flex justify-between items-center">
                                    <label for="budget" class="block text-sm font-medium text-gray-700">Budget (Rupee)</label>
                                    <div class="tooltip">
