        ...
        <nav class="nav-container fixed w-full z-50 px-6 py-4">
            <div class="max-w-7xl mx-auto flex justify-between items-center">
                <a href="/" class="logo-container group">
                    ...
                    <span class="text-2xl gradient-text relative z-10">HeavenTravel</span>
        ...
        <div class="hero-section">
            ...
            <div class="hero-content max-w-7xl mx-auto px-6 text-center relative z-10">
                <div class="hero-badge mb-6">
                    <span class="badge-text">Start Your Journey to New Destinations.</span>
                ...
                Embark on unforgettable journeys, discover exciting new destinations, and make memories that last a lifetime with Heaven Travel.
                </p>
                ...
                <div class="hero-stats mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                    <div class="stat-item">
                        <div class="stat-number" data-count="650+">0</div>
        ...
        <div class="py-24 px-6" id="features">
            <div class="max-w-7xl mx-auto">
                <div class="text-center mb-16">
                    <h2 class="text-4xl font-bold mb-4 gradient-text">Why Choose HeavenTravel?</h2>
                    <p class="text-xl text-gray-600">Your one-stop destination for all the essentials to create your perfect trip.</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="feature-card floating-element delay-2" data-feature="community-insights">
                        ...
                        <p class="text-gray-600">Connect with like-minded travelers and receive genuine recommendations from locals for an authentic travel experience.</p>
                    </div>
                    <div class="feature-card floating-element delay-3" data-feature="safe-travel">
                        ...
                        <p class="text-gray-600">Stay informed with real-time safety alerts and get 24/7 emergency assistance for peace of mind during your travels.</p>
                    </div>
                </div>
        ...
        <div class="contact-section" id="contact">
            <div class="max-w-7xl mx-auto px-6">
                <div class="text-center mb-16">
                    ...
                    <p class="text-xl text-gray-600">Got questions? We're here to help and would love to hear from you.</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div class="contact-card">
                            ...
                            <p class="text-gray-600">987654321</p>
                        </div>
                        <div class="contact-card">
                            <div class="contact-icon">
                            ...
                            <p class="text-gray-600">contactheaventravel@gmail.com</p>
                        </div>
                    </div>
            ...
            <div class="relative max-w-7xl mx-auto px-6 pt-16 pb-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div class="space-y-6">
                        ...
                        Uncover your next journey with HeavenTravel. We curate the ideal destination based on your unique preferences, ensuring unforgettable experiences every step of the way.
                        </p>
                ...
                <div class="pt-8 mt-12 border-t border-white/10">
                    <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <p class="text-gray-400 text-sm">
                            © {{ date('Y') }} HeavenTravel. All rights reserved.
                        </p>
